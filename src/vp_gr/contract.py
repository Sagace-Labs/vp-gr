...
OUTPUTS: list[dict[str, Any]] = [
    {
        ...
        "range": [0.0, 1.0],
        "semantics": (
            "P(activates the glucocorticoid receptor reporter in the Tox21 qHTS "
            "agonist screen)"
        ),
    ...
    },
    {
        ...
        "range": [0.0, 1.0],
        "semantics": (
            "P(suppresses the hormone-driven glucocorticoid receptor reporter in the "
            "Tox21 qHTS antagonist screen)"
        ),
        "missing": "NaN when RDKit cannot parse the input SMILES",
    },
    {
        ...
        "semantics": (
            ...
            "compound that kills the cell suppresses the reporter and reads as an "
            "antagonist, so a high score here qualifies the antagonist column"
        ),
        "missing": "NaN when RDKit cannot parse the input SMILES",
    },
]
