"""Measure a version under an evaluation protocol.
    ...
    python -m vp_gr.evaluate --version v1
...
from vp_gr.train import OUTPUT_LABELS
...
def evaluate_version(
    ...
    *,
    ...
    table = gr_data.example() if use_example else gr_data.load()
    ...
    primary = scored[gr_contract.PRIMARY]
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="python -m vp_gr.evaluate")
    ...
    version = args.version or vp_gr.current_version()
