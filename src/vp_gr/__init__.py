"""Glucocorticoid receptor / NR3C1 activity from a SMILES string.

The receptor governs hepatic gluconeogenesis, lipid handling and the
inflammatory response, so a xenobiotic that drives or blocks it at its response
element perturbs those programmes — a molecular initiating event for
...
from vp_gr.target import ANTAGONIST, CYTOTOX, TARGET, TARGETS, Endpoint, all_names
from vp_gr.target import get as get_target
